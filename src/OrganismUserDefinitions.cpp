...
OrganismUserDefinitions::OrganismUserDefinitions( std::string path )
{
	...
	lifeExpectative = float( loadData["lifeExpectative"] );	

	loadData.clear();
}

void OrganismUserDefinitions::printInfo()
{
	std::cout << 
	"lifeExpectative: " << lifeExpectative << 
	std::endl;
}
